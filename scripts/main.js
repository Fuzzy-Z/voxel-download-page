...
let currentDownloadUrl = 'https://github.com/Fuzzy-Z/PulseCord/releases/download/v1.0.94/Voxel-Setup-1.0.94.exe';
let currentVersion = '1.0.94';
let currentFileSize = '127 MB';
let currentFileName = 'Voxel-Setup-1.0.94.exe';
